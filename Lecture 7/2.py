...
pygame.init()
playlist = []
musics = r"/Users/albina/Desktop/Lecture 7/musics"  

my_musics = os.listdir(musics)
for i in my_musics:
    if i.endswith(".mp3"):
        playlist.append(os.path.join(musics, i)) 
...
background = pygame.image.load(os.path.join("music", "popmusic_imresizer.jpg"))
